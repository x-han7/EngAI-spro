...
export class UserService {
  ...
  async uploadAvatar(file: Express.Multer.File) {
    ...
    const databaseUrl = `/${bucket}/${fileName}`; //数据库url /engai-avatar/1234567890-xiaomansdas.jpg
    const previewUrl = `${baseUrl}://${this.configService.get('MINIO_ENDPOINT')}:${port}${databaseUrl}`;
    //previewUrl->http://192.168.41.96:9000/engai-avatar/1234567890-xiaomansdas.jpg
    //databaseUrl->/engai-avatar/1234567890-xiaomansdas.jpg
